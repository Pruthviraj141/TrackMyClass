...
# Frontend paths
TEMPLATES_DIR = ATTENDANCE_SYSTEM_DIR / "legacy_frontend" / "templates"
STATIC_DIR = ATTENDANCE_SYSTEM_DIR / "legacy_frontend" / "static"
...
# ──────────────────────────────────────────────
TEMPORAL_MIN_FRAMES = 2           # Must be seen in ≥ N frames before marking (~2s at 2FPS)
TEMPORAL_MIN_CONFIDENCE = SIMILARITY_THRESHOLD    # Average confidence across tracked frames
...
# ──────────────────────────────────────────────
FRAME_RESIZE_WIDTH = 320          # Resize frame width before detection
SKIP_DETECTION_FRAMES = True      # If True, run MTCNN every alternate frame
